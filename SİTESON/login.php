...
{ 
    ...
    if($ilgiliKayit["id"]==1)  //admin mi diye kontrol ediyor id ile ad ile yapması için burdan değiştirceğiz 
    {
        ...
        <div class="col-md-3 kutu">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <button type="submit" class=" btn-primary btn-block" name="btnGiris" value="Giriş">Giriş</button>
